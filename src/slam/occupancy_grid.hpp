...
public:
    ...
    */
    ...
    /**
    * convertPointToCell converts a Point<float> to the coordinate of the cell
    *
    * \param    point               Point to be converted
    * \return   cell                The converted point
    */
    Point<int> convertPointToCell(const Point<float>& point);
