...
Point<int> OccupancyGrid::convertPointToCell(const Point<float>& point)
{
    int i, j;
    i = (int) (point.x / metersPerCell_) + (int) widthInCells() / 2;
    j = (int) (point.y / metersPerCell_) + (int) heightInCells() / 2;
